...
<div class="modal-body">
    <table style="width:100%;" class="table table-bordered">
        <tr>
            <th colspan="3" id="addHeader" style="text-transform:uppercase;"><center><strong>Create New Designation</strong><br>
            <span style="color:red;" id="spanWarning"></span>
            </center></th>
        </tr>
    </table>
    <form action="/create_designation/{{ csrf_token() }}" method="post"  enctype="multipart/form-data" style="z-index:10;">
        ...
        <center>
            <table class="table table-bordered" style="width:100%;">
                <tr>
                    ...
                    <td><input type="text" name="desig_name" id="desig_name" class="form-control" required>
                        <span id="span">
