...
<div class="modal-body">
    <table style="width:100%;" class="table table-bordered">
        <tr>
            <th colspan="3" id="addHeader" style="text-transform:uppercase;"><center><strong>Create EMployee Login</strong><br>
            <span style="color:red;" id="spanWarning"></span>
            </center></th>
        </tr>
    </table>
    <form action="/manager_create_emp_login/{{ csrf_token() }}" method="post"  enctype="multipart/form-data" style="z-index:10;">
        ...
        <center>
            <table class="table table-bordered" style="width:100%;">
                ...
                <tr>
                    <td>Login Name</td>
                    <td><input type="text" name="login_name" id="login_name" class="form-control" required></td>
                </tr>

                <tr>
                    <td>Login Id</td>
                    <td><input type="text" name="login_id" id="login_id" class="form-control" required></td>
                </tr>
                <tr>
                    <td>Login Password</td>
                    <td><input type="text" name="login_password" id="login_password" class="form-control" required></td>
                </tr>
