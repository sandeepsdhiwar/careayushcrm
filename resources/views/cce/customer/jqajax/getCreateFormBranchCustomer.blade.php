...
<div class="modal-body">
    ...
    <form action="/create_branch_customer/{{ csrf_token() }}" method="post"  enctype="multipart/form-data" style="z-index:10;">
        ...
        <center>
            <table class="table table-bordered" style="width:100%;">
                ...
                <tr>
                    ...
                    <td><input type="text" name="cust_location" id="cust_location" class="form-control"></td>
                </tr>
                <tr>
                    <td>Address</td>
                    <td><textarea name="cust_address" id="cust_address" class="form-control"></textarea></td>
                </tr>
